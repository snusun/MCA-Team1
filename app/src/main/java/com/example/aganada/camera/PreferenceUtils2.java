...
public class PreferenceUtils2 {
    ...
    public static android.util.Size getCameraXTargetResolution(Context context, int lensfacing) {
        ...
        String prefKey =
                lensfacing == CameraSelector.LENS_FACING_BACK
                        ? context.getString(Integer.parseInt("pref_key_camerax_rear_camera_target_resolution"))
                        : context.getString(Integer.parseInt("pref_key_camerax_front_camera_target_resolution"));
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        try {
    ...
    */
    ...
    public static boolean isCameraLiveViewportEnabled(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(Integer.parseInt("pref_key_camera_live_viewport"));
        return sharedPreferences.getBoolean(prefKey, false);
    }

    private PreferenceUtils2() {}
}
